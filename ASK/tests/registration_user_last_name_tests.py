...
class UserLastNameTestSuit(unittest.TestCase):
    ...
    def test_last_name_alphanumerical_and_special_char(self):
        """ Verify that user can be created with 5 alphanumerical & special characters in Last name """
        driver = self.driver
        wait = self.wait
    ...
    def test_last_name_single_char(self):
        """ Verify that user can be created with single character in Last name """
    ...
    def test_last_name_zero_char(self):
        """ Verify that user can not create account with Last name missing """
        ...
        actual_error_msg = driver.find_element_by_xpath("//input[@id='mat-input-1']/../../..//mat-error").text
        self.assertEqual(expected_error_msg, actual_error_msg)


    def test_last_name_max_char(self):
        """ Verify that user can be created with 254 alphanumerical & special characters in Last name """
        driver = self.driver
        wait = self.wait

        #test data
        first_name = "I"
        last_name = "iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV@#7iV" \
    ...
    def test_last_name_max_character_plus_one(self):
        """ Verify that user can not create account with 254 plus one alphanumerical & special characters in Last name """
    ...
    def test_last_name_leading_space(self):
        """ Verify that user can not create account with leading space in Last name """
    ...
    def test_last_name_trailing_space(self):
        """ Verify that user can not create account with trailing space in Last name """
    ...
    def test_last_name_space_character_inside(self):
        """ Verify that user can not create account with space character inside Last name """
